...
const overlayVariants = {
    open: { 
        ...
        transition: { 
            duration: 0.8, 
            ease: [0.22, 1, 0.36, 1] // equivalent to easeOutQuint
        } 
    },
    closed: { 
        width: 0, 
        transition: { 
            duration: 0.5, 
            ease: [0.32, 0, 0.67, 0] // equivalent to easeInQuint
        } 
    }
};
...
const panelVariants = {
    open: { 
        ...
        transition: { 
            delay: 0.3, 
            duration: 0.5, 
            ease: [0.76, 0, 0.24, 1] // equivalent to easeInOutQuint
        } 
    },
    closed: { 
        width: 0, 
        transition: { 
            duration: 0.4, 
            delay: 0.1,
            ease: "easeIn" // Using a named easing function
        } 
    }
};
